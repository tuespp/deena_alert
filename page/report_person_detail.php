...
if ($_POST['oa_id'] == null || $_POST['line_id'] == null) {


    echo "<script type='text/javascript'>alert('กรุณากรอกข้อมูลให้ครบถ้วน');
        window.location = 'report_person.php';
    ...
    <script>
        ...
        function add_text() {
            ...
            var txt2 =
                ...
                "<div>" +
                "<form target='_blank' action='../backend/report_line2_text_person.php' method='POST'  enctype='multipart/form-data'>" +
                ...
                "</div>" +
                "<div class='form-group'>" +
                "<input type='text' name='oa_id' id='oa_id' hidden value='<?php echo $oa_id ?>'><input type='text' name='line_id' id='status' hidden value='<?php  echo htmlentities(serialize($line_id)); ?>'>" +
        ...
        function add_img() {
            ...
            var txt3 =
                ...
                '</div>' +
                '<form target="_blank" action="../backend/report_line2_img_person.php" method="POST" id="form_img' + str_send + '" enctype="multipart/form-data">' +
                '<div class="form-group">' +
                '<div class="card-body">' +
                '<hr>' +
