                                            ...
                                            <div class="row">
                                                <div class="col-md-4 ">
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="text" name="percent" id="percent" placeholder="จำนวนเปอร์เซ็น" class="form-control" 
                                                        value="<?php echo ($row_m['ins1'] * 100) / $row_ins['total']; ?>" required>
                                                        <div class="input-group-prepend">
                                                ...
                                                <div class="col-md-4 mt-2 ">
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="text" name="percent2" id="percent2" placeholder="จำนวนเปอร์เซ็น" class="form-control" value="<?php echo ($row_m['ins2'] * 100) / $row_ins['total']; ?>">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">%</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-4 mt-2 ">
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="text" name="percent3" id="percent3" placeholder="จำนวนเปอร์เซ็น" class="form-control" value="<?php echo ($row_m['ins3'] * 100) / $row_ins['total']; ?>">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">%</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-4 mt-2 ">
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="text" name="percent4" id="percent4" placeholder="จำนวนเปอร์เซ็น" class="form-control" value="<?php echo ($row_m['ins4'] * 100) / $row_ins['total']; ?>">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">%</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-4 mt-2 ">
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="text" name="percent5" id="percent5" placeholder="จำนวนเปอร์เซ็น" class="form-control" value="<?php echo ($row_m['ins5'] * 100) / $row_ins['total']; ?>">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">%</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-4 mt-2 ">
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="text" name="percent6" id="percent6" placeholder="จำนวนเปอร์เซ็น" class="form-control" value="<?php echo ($row_m['ins6'] * 100)/$row_ins['total'] ?>">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">%</div>
                                                        </div>
                                                    </div>
