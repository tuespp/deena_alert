    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 style="text-transform: uppercase">ขอสินเชื่อเบี้ยประกัน รูปแบบที่ 3 (เขียวเหลือง)</h1>
                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-group mb-2">
                                                        <input type="text" name="car_price" id="ins_price" placeholder="จำนวน" class="form-control" value="11858.81" required>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group mb-2">
                                                            ...
                                                            <input type="text" name="total" id="price" placeholder="จำนวนเงิน" class="form-control" value="13900.37" required>
                                                            <div class="input-group-prepend">
                                                                <div class="input-group-text">บาท</div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 "> <label class="mt-3" for="exampleInputPassword1">ชำระงวดแรกเป็นเงิน <span class="red">*</span></label>
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="text" name="price_ins1" id="ins1" placeholder="จำนวนเงิน" class="form-control" value="3000">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">บาท</div>
                                                        </div>
                                                    </div>
