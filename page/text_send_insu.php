                ...
                <div class=" offset-md-3 col-md-6">
                    ...
                    <div class=" offset-md-3 col-md-6">
                        ...
                        <div class="card card-warning" >
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="../backend/insurance_text_send.php" method="POST">
                                ...
                                <div class="card-body" id="text-sent">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="text-3" name="text-3" value="<?php echo $row_txt['text_date']?>" placeholder="ประเภท" required>
                                    </div>
                                    <div class="form-group">
