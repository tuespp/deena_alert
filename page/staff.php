...
<body class="hold-transition sidebar-mini">
    ...
    <div class="content-wrapper">
        ...
        $sql2 = "SELECT * FROM users_info WHERE level = 'employee' ";
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <a href="staff_insert.php" name="but_update" class="btn btn-warning">เพิ่มข้อมูล</a>
                                <br><br>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($result2 as $value) { ?>
                                            <tr>
                                                ...
                                                <td><img src="../img/<?php echo $value['img'] ?>" alt="" width="100"></td>
