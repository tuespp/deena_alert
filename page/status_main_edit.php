            ...
            <div class="container-fluid ">
                ...
                <div class="offset-sm-3 col-md-6">
                        ...
                        <div class="card card-warning">
                            ...
                            <form action="../backend/status_main_db_edit.php" method="POST">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputEmail1" name="name" value="<?php echo $row['status_name']; ?>" placeholder="Insurance Name" required>
