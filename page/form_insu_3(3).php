    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 style="text-transform: uppercase">ขอสินเชื่อเบี้ยประกัน รูปแบบที่ 3 (สหกรณ์)</h1>
                    </div>
                                        ...
                                        <div class="mb-2">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="hidden" name="ins_type" placeholder="วันที่เขียน" class="form-control" value="แบบ3 (เขียวเหลือง)">
                                    ...
                                    <div id="divv">
                                        ...
                                        <div class="form-group mt-3">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <select name="car_insu" class="custom-select" id="car_type" required>
                                                        ...
                                                        <?php while ($row = mysqli_fetch_array($resultc)) {
                                                            ...
                                                            if ($row['comp_name'] == 'ไทยศรี ประกันภัย') { ?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-group mb-2">
                                                        <input type="text" name="car_price" id="ins_price" placeholder="จำนวน" class="form-control" value="14859.09" required>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-group mb-2">
                                                        <input type="text" name="car_price2" id="ins_price2" placeholder="จำนวน" class="form-control" value="2041.56" required>
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">บาท</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group mb-2">
                                                            ...
                                                            <input type="text" name="total" id="price" placeholder="จำนวนเงิน" class="form-control" value="1600.65" required>
                                                            <div class="input-group-prepend">
                                                                <div class="input-group-text">บาท</div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6"> <label class="mt-3" for="exampleInputPassword1">ขอผ่อนชำระทั้งหมด <span class="red">*</span></label>
                                                        ...
                                                        <div class="input-group mb-2">
                                                            <input type="text" name="installment" id="installment" placeholder="งวด" class="form-control" value="6" required>
                                                            <div class="input-group-prepend">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 "> <label class="mt-3" for="exampleInputPassword1">ชำระงวดแรกเป็นเงิน <span class="red">*</span></label>
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="text" name="price_ins1" id="ins1" placeholder="จำนวนเงิน" class="form-control" value="4000">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">บาท</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6 "> <label class="mt-3" for="exampleInputPassword1">คงเหลืองวดที่ต้องชำระ<span class="red">*</span></label>
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="text" name="installment2" id="installment2" placeholder="งวดที่เหลือ" class="form-control" value="5">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">งวด</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6 mt-2">
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="text" name="price_ins2" id="ins2" placeholder="installment 2" class="form-control" value="2580">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">บาท</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6 mt-2">
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="text" name="price_ins3" id="ins3" placeholder="installment 3" class="form-control" value="2580">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">บาท</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6 mt-2">
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="text" name="price_ins4" id="ins4" placeholder="installment 4" class="form-control" value="2580">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">บาท</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6 mt-2">
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="text" name="price_ins5" id="ins5" placeholder="installment 5" class="form-control" value="2580">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">บาท</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6 mt-2">
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="text" name="price_ins6" id="ins6" placeholder="installment 6" class="form-control" value="2580">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">บาท</div>
                                                        </div>
                                                    </div>
