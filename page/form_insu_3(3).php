                                        ...
                                        <div class="mb-2">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="hidden" name="ins_type" placeholder="วันที่เขียน" class="form-control" value="แบบ3 (สหกรณ์)">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group mb-2">
                                                            ...
                                                            <input type="text" name="total" id="price" placeholder="จำนวนเงิน" class="form-control" value="16900.65" required>
                                                            <div class="input-group-prepend">
                                                                <div class="input-group-text">บาท</div>
                                                            </div>
                                                        </div>
