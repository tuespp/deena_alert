            ...
            <div class="card-body">
              <div class="tab-content">
                <div class="active tab-pane" id="activity">
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal" action="../backend/profile_reset.php?id=<?php echo $row['id'] ?>" method="post">
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-3 col-form-label"> <strong> รหัสผ่านเดิม</strong></label>
                        <div class="col-sm-9">
