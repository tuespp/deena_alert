 ...
 */
   ...
   $date_ins2 = $_POST['date1'];
    ...
    $sql = "UPDATE `ins_form` SET `date_create`='$date_create',
    `date_start`='$date_start',`car_license`='$car_license',`name`='$fullname',`id_card`='$id_card',
    `birth_date`='$birth_date',`address`='$address',`tel`='$tel',`tel1`='$tel3',
    `address2`='$address2',`tel2`='$tel2',`name_grt`='$name_grt',`relation_grt`='$relation_grt',
    `tel_grt`='$tel_grt',`car_type`='$car_type',`car_insu`='$car_insu',`car_price`='$car_price',
    `car_type2`='$car_type2',`car_insu2`='$car_insu2',`car_price2`='$car_price2',`total`='$total',
    ...
    $sql_insert = "UPDATE `installment` SET `ins1`='$price_ins1',
    `date1`='$date_create',
    `ins2`='$price_ins2',`date2`='$date_ins2',`date_send2`='$date_send2',
    `ins3`='$price_ins3',`date3`='$date_ins3',`date_send3`='$date_send3',
    `ins4`='$price_ins4',`date4`='$date_ins4',`date_send4`='$date_send4',
    `ins5`='$price_ins5',`date5`='$date_ins5',`date_send5`='$date_send5',
    `ins6`='$price_ins6',`date6`='$date_ins6',`date_send6`='$date_send6'
    
    WHERE form_id = '$form_id'";
    $result_insert = mysqli_query($con, $sql_insert)  or die(mysqli_error($con));

    $sql_loop = "SELECT * FROM installment WHERE form_id = $form_id";
